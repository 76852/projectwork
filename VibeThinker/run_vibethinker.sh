#!/bin/bash
# VibeThinker-1.5B记忆率测试脚本

# ==================== 配置区域 ====================
BASE_DIR="/zhangguangyi01/Lianghongjian"
SCRIPT="${BASE_DIR}/code/vibethinker_test.py"
...
# 创建日志文件
LOG_FILE="${LOG_DIR}/vibethinker_test_$(date +%Y%m%d_%H%M%S).log"
mkdir -p "${LOG_DIR}"
...
log "[INFO] 开始VibeThinker-1.5B记忆率测试"
log "[INFO] 启动测试执行"
