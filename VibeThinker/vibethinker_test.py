...
class VibeThinkerTester:
    ...
    def test_complete_memorization(self, max_new_tokens=50):
        ...
        for i, item in enumerate(test_data):
            try:
                ...
                self.stats['success_count'] += 1  # 只有成功生成文本才计为成功
    ...
    def save_complete_results(self):
        ...
        output_path = output_dir / f"vibethinker_results_{timestamp}.json"
...
if __name__ == "__main__":
    try:
        # 初始化测试器
        tester = VibeThinkerTester(
            model_path="/zhangguangyi01/Lianghongjian/WeiboAI_VibeThinker_1.5B",
